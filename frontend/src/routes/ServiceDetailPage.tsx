      ...
      <AsyncBoundary isLoading={service.isLoading} isError={service.isError} data={service.data}>
        {(data) => (
          <div className="flex flex-col gap-6">
            ...
            <Card className="p-5">
              <h2 className="mb-4 font-medium text-text-primary">Roll back</h2>
              <AsyncBoundary
            ...
            <Card className="flex flex-col">
              <div className="flex items-center justify-between border-b border-border px-5 py-4">
                <h2 className="font-medium text-text-primary">Deployment history</h2>
                  ...
                  <BoardTable
                    ...
                    emptyState={
                      <EmptyState
                        ...
                        title="No deployments captured yet"
                        description="A snapshot is captured automatically whenever this service's image or tag changes."
                      />
                    }
                    keyFn={(s) => s.id}
                    columns={[
