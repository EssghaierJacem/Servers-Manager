  ...
  return (
    <Card className="flex flex-col gap-4 p-6">
      <div className="flex flex-col gap-1">
        <h2 className="text-text-primary">Finish setting up {hostName}</h2>
        ...
        {(data) => (
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <span className="text-sm text-text-muted">Public key</span>
              <pre className="overflow-x-auto whitespace-pre-wrap break-all rounded-lg border border-border bg-bg-base p-3 font-mono text-xs text-text-primary">
                {data.ssh_public_key}
              </pre>
            </div>

            <div className="flex flex-col gap-1.5">
              <span className="text-sm text-text-muted">Bootstrap command</span>
              <div className="flex items-start gap-2">
                <pre className="flex-1 overflow-x-auto whitespace-pre-wrap break-all rounded-lg border border-border bg-bg-base p-3 font-mono text-xs text-text-primary">
